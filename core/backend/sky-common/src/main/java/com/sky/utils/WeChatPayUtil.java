...
public class WeChatPayUtil {
    ...
    private CloseableHttpClient getClient() {
        ...
        try {
            ...
            log.error("微信支付证书文件未找到", e);
            throw new RuntimeException("支付配置错误", e);
        }
    }
    ...
    public ObjectNode pay(String orderNum, BigDecimal total, String description, String openid) throws Exception {
        ...
        //解析返回结果
        ObjectNode jsonObject = (ObjectNode) objectMapper.readTree(bodyAsString);
        log.debug("微信支付下单响应: {}", jsonObject);

        String prepayId = jsonObject.get("prepay_id").asText();
        if (prepayId != null) {
